...
st.markdown("Upload 1 to 10 images, choose an style and let AI write and narrate a story for you.")
...
with st.sidebar:
    ...
    ("Comedy","Thriller", "Fairy Tales", "Sci-Fi", "Mystery", "Adventure", "Morale")
    )
    ...
    if not uploaded_files:
        ...
        with st.spinner("The AI is writing and narrating your story...This may take few moments"):
            try:
                ...
                if "Error in generated_story" or "failed" in generate_story or "API key" in generate_story:
